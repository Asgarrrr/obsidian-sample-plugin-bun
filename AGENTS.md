...
**Note**: This sample project has specific technical dependencies on bun and esbuild. If you're creating a plugin from scratch, you can choose different tools, but you'll need to replace the build configuration accordingly.
